...
This document defines the non-functional requirements for Milestone 1 of the Physics Learning Platform. These requirements specify the quality attributes that the system shall satisfy.

---

## 3.1 Performance

**NFR-001:** The system shall respond to user requests within a reasonable time under normal operating conditions.

**NFR-002:** The system shall support multiple users accessing the platform simultaneously without significant degradation in performance.

---

## 3.2 Security

**NFR-003:** User passwords shall be securely stored using password hashing.
...
|---|---|---|
| 1.0 | August 4, 2026 | Initial baseline for Milestone 1 non-functional requirements. |
